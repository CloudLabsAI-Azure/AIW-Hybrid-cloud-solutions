...
## Note: This is read only exercise, Azure Arc enabled PostgreSQL is in preview and Microsoft product team is working on enhancing it. The exercise is not dependent on any other exercise and users will be able to complete the other exercises without any issues
