...
1. You can save the query for later use by clicking on the **Save** button.
...
1. Then, you will find `VMProcess` query under **Queries**, click on **Run** to run the querie.
