...
1. You can see a virtual machine desktop 💻 (LabVM/ARCHOST) is loaded on the left side in your browser. Use this virtual machine throughout the workshop to perform the lab.
...
1. Click on the **azure-arc** Resource group and check if the resources below are deployed successfully.
...
1. Then search and verify if **ubuntu-k8s** resource of resource type: **Machine - Azure Arc** got created. Click on the resource to get more information.
   ...
   ![](.././media/exe1-task2-step17-verify-ubuntuk8s.png "ubuntu k8s onboarded")
