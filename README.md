...
#### Click on each of the scenarios below to see the specific instructions to do the lab:
  ...
  * [Hands-on Lab 3](https://github.com/CloudLabsAI-Azure/AVW-Arc-enabled-dataservices/blob/main/Instructions/README.md): In this lab, you’ll leverage the same Arc enabled Kubernetes cluster from the previous labs to deploy the Azure Arc data controller, Azure SQL Managed Instance & Azure PostgreSQL Hyperscale.
