...
[Connecting to Azure Hybrid Services](https://docs.microsoft.com/en-us/windows-server/manage/windows-admin-center/azure/azure-backup)


Task 2: Arc-enabled the VM you just created
----
