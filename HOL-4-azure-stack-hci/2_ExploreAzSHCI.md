...
- [HOL-4: Exercise 2: Explore the management of your Azure Stack HCI 22H2 environment](#hol-4-exercise-2-explore-the-management-of-your-azure-stack-hci-22h2-environment)
  - [Overview](#overview)
  - [Contents](#contents)
  - [Task 1: Review the existing volumes for VMs](#task-1-review-the-existing-volumes-for-vms)
    - [Review a two-way mirror volume](#review-a-two-way-mirror-volume)
...
Task 1: Review the existing volumes for VMs
-----------
...
### Review a two-way mirror volume ###
