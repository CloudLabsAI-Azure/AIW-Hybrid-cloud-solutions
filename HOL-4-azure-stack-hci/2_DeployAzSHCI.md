...
Next Steps
-----------
In this step, you've successfully created a nested Azure Stack HCI 20H2 cluster using Windows Admin Center. With this complete, you can now [Integrate Azure Stack HCI 20H2 with Azure](https://github.com/CloudLabsAI-Azure/AIW-Hybrid-cloud-solutions/blob/main/HOL-4-azure-stack-hci/3_AzSHCIIntegration.md "Integrate Azure Stack HCI 20H2 with Azure")
